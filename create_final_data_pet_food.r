...
write.table(super_shops_ids, "/home/michela/nz_pet_food/super_shops_ids.psv", sep = "|", row.names = FALSE, col.names = TRUE)
...
write.table(dex_cau, "/home/michela/nz_pet_food/dex_cau.psv", sep = "|", row.names = FALSE, col.names = TRUE)
...
write.table(sales_by_store, "/home/michela/nz_pet_food/sales_by_store.psv", sep = "|", row.names = FALSE, col.names = TRUE)
...
top_5 <- sales_by_store_155_weeks_2[, tail(.SD, 5)]
...
write.table(final_list_shops_itens, "/home/michela/nz_pet_food/final_list_shops_itens.psv", sep = "|", row.names = FALSE, col.names = TRUE)
...
write.table(final_list_shops_itens_small, "/home/michela/nz_pet_food/final_list_shops_itens_small.psv", sep = "|", row.names = FALSE, col.names = TRUE)
...
write.table(final_list_shops_itens_small_short, "/home/michela/nz_pet_food/final_list_shops_itens_small_short.psv", sep = "|", row.names = FALSE, col.names = TRUE)
write.table(final_list_shops_itens_small_long, "/home/michela/nz_pet_food/final_list_shops_itens_small_long.psv", sep = "|", row.names = FALSE, col.names = TRUE)
...
final_list_shops_itens_small <- fread("/home/michela/nz_pet_food/final_list_shops_itens_small.psv", sep = "|")
final_list_shops_itens_small_short <- fread("/home/michela/nz_pet_food/final_list_shops_itens_small_short.psv", sep = "|")
final_list_shops_itens_small_long <- fread("/home/michela/nz_pet_food/final_list_shops_itens_small_long.psv", sep = "|")
...
# Save data
##########################################
write.table(final_data_pet_food, "/home/michela/nz_pet_food/final_data_pet_food.psv", sep = "|", row.names = FALSE, col.names = TRUE)
