...
write.table(super_shops_ids, "/home/hagen/super_shops_ids.psv", sep = "|", row.names = FALSE, col.names = TRUE)
...
write.table(dex_cau, "/home/hagen/dex_cau.psv", sep = "|", row.names = FALSE, col.names = TRUE)
...
write.table(sales_by_store, "/home/hagen/sales_by_store.psv", sep = "|", row.names = FALSE, col.names = TRUE)

#########################################################################
# Select top 25 items (sales volume) per store
#########################################################################
...
#setkeyv(sales_by_store_103_weeks, c("item_id","sum_corrected_sales_in_volume"))

#bottom_5 <- sales_by_store_103_weeks[, head(.SD, 5), by=shop_id]
top_25 <- sales_by_store_103_weeks[, tail(.SD, 25), by=shop_id]


#alternatively:

library(readr)
new_market_share_coke <- read_delim("~/Desktop/nielsen/new market share coke.csv",
"\t", escape_double = FALSE, trim_ws = TRUE)

View(new_market_share_coke)
top_25_2 <- new_market_share_coke
...
# sales_by_store_103_weeks_4 <- sales_by_store_103_weeks_3[,sum_sales_all_itens := sum(sum_sales_all_itens), by = shop_id]
# 
...
#final_list_shops_itens <- itens_shops
final_list_shops_itens <- top_25
 
write.table(final_list_shops_itens, "/home/hagen/final_list_shops_itens.psv", sep = "|", row.names = FALSE, col.names = TRUE)
...
###########################################################
# 
cols_to_keep <- c("shop_id" ,"item_id", "item_selected" ,"shop_selected" ,"sum_corrected_sales_in_volume" )
...
# #[1] 553   4
# 
write.table(final_list_shops_itens_small, "/home/hagen/final_list_shops_itens_small.psv", sep = "|", row.names = FALSE, col.names = TRUE)
# 
# 
# ##################################################################################
...
# #[1] 553   2
# 
 write.table(final_list_shops_itens_small_short, "/home/hagen/final_list_shops_itens_small_short.psv", sep = "|", row.names = FALSE, col.names = TRUE)
 write.table(final_list_shops_itens_small_long, "/home/hagen/final_list_shops_itens_small_long.psv", sep = "|", row.names = FALSE, col.names = TRUE)
# 
# 
# ######################################################
...
# write.table(final_list_shops_itens, "/home/hagen/final_list_shops_itens.psv", sep = "|", row.names = FALSE, col.names = TRUE)
 ...
 final_list_shops_itens <- fread("/home/hagen/final_list_shops_itens_small.psv", sep = "|")
 #write.table(sales_by_store, "/home/hagen/sales_by_store.psv", sep = "|", row.names = FALSE, col.names = TRUE)
 sales_by_store <- fread("/home/hagen/sales_by_store.psv", sep = "|")
 final_list_shops_itens_small <- fread("/home/hagen/final_list_shops_itens_small.psv", sep = "|")
 final_list_shops_itens_small_short <- fread("/home/hagen/final_list_shops_itens_small_short.psv", sep = "|")
 final_list_shops_itens_small_long <- fread("/home/hagen/final_list_shops_itens_small_long.psv", sep = "|")
 dex_cau <- fread("/home/hagen/dex_cau.psv", sep = "|")
 
 
 final_list_shops_itens <- fread("/Users/hagen/Nielson/final_list_shops_itens_small.psv", sep = "|")
 #write.table(sales_by_store, "/sales_by_store.psv", sep = "|", row.names = FALSE, col.names = TRUE)
 sales_by_store <- fread("/Users/hagen/Nielson/sales_by_store.psv", sep = "|")
 final_list_shops_itens_small <- fread("/Users/hagen/Nielson/final_list_shops_itens_small.psv", sep = "|")
 final_list_shops_itens_small_short <- fread("/Users/hagen/Nielson/final_list_shops_itens_small_short.psv", sep = "|")
 final_list_shops_itens_small_long <- fread("/Users/hagen/Nielson/final_list_shops_itens_small_long.psv", sep = "|")
 dex_cau <- fread("/Users/hagen/Nielson/dex_cau.psv", sep = "|")
...
#nz_coke_dex_cau_simple <- unique(nz_coke_dex_cau_simple[c("")])
dim(nz_coke_dex_cau_simple)
#[1] 6479    4
...
# Save data
##########################################
#write.table(final_data_coke, "/home/hagen/final_data_coke.psv", sep = "|", row.names = FALSE, col.names = TRUE)


#write.table(super_shops_ids, "/home/hagen/super_shops_ids.psv", sep = "|", row.names = FALSE, col.names = TRUE)
super_shops_ids <- fread("/home/hagen/super_shops_ids.psv", sep = "|")
##########################################
...
#query_2 <- paste0("select * from nz_coke.dex_dmf WHERE shop_id in (",super_shops_ids,")" )
...
# Save data
##########################################
write.table(final_data_coke, "/home/hagen/final_data_coke_70.psv", sep = "|", row.names = FALSE, col.names = TRUE)