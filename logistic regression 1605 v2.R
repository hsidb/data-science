...
#friday 31.08.2017:
mergedtraining6d7d9dretailer_v2$z = rep(1,47343)
mergedtraining6d7d9dretailer_v2$z[mergedtraining6d7d9dretailer_v2$z == '1'] <- 0
mergedtraining6d7d9dretailer_v2$z[mergedtraining6d7d9dretailer_v2$Major_Ind == '1'] <- 1
mergedtraining6d7d9dretailer_v2$z[mergedtraining6d7d9dretailer_v2$Minor_Ind == '1'] <- 1

mergedtest6d7d9dretailer_v2$z = rep(1,21054)
mergedtest6d7d9dretailer_v2$z[mergedtest6d7d9dretailer_v2$z == '1'] <- 0
mergedtest6d7d9dretailer_v2$z[mergedtest6d7d9dretailer_v2$Major_Ind == '1'] <- 1
mergedtest6d7d9dretailer_v2$z[mergedtest6d7d9dretailer_v2$Minor_Ind == '1'] <- 1



mergedtraining6d7d9dretailer_v2$display_level2 = rep(1,47343)
mergedtraining6d7d9dretailer_v2$display_level2[mergedtraining6d7d9dretailer_v2$Minor_Ind == '1']  <- 2
mergedtraining6d7d9dretailer_v2$display_level2[mergedtraining6d7d9dretailer_v2$Major_Ind == '1']  <- 3
mergedtraining6d7d9dretailer_v2$display_level2 <- factor(mergedtraining6d7d9dretailer_v2$display_level2, levels = c("1", "2", "3"), ordered = TRUE)

mergedtest6d7d9dretailer_v2$display_level2 = rep(1,21054)
mergedtest6d7d9dretailer_v2$display_level2[mergedtest6d7d9dretailer_v2$Minor_Ind == '1']  <- 2
mergedtest6d7d9dretailer_v2$display_level2[mergedtest6d7d9dretailer_v2$Major_Ind == '1']  <- 3
mergedtest6d7d9dretailer_v2$display_level2 <- factor(mergedtest6d7d9dretailer_v2$display_level2, levels = c("1", "2", "3"), ordered = TRUE)

mergedtest6d7d9dretailer_v3$ppi <- mergedtest6d7d9dretailer_v3$PRICE/mergedtest6d7d9dretailer_v3$`BASELINE PRICE`
mergedtraining6d7d9dretailer_v3$ppi <- mergedtraining6d7d9dretailer_v3$PRICE/mergedtraining6d7d9dretailer_v3$`BASELINE PRICE`

mergedtest6d7d9dretailer_v3$ppi_flag <- ifelse(mergedtest6d7d9dretailer_v3$ppi  <= '0.95', '1','0')
mergedtraining6d7d9dretailer_v3$ppi_flag <- ifelse(mergedtraining6d7d9dretailer_v3$ppi <= '0.95', '1','0')
# final_data_coke_40$Display_Ind <- ifelse(final_data_coke_40$No_display_Ind==1, '0', '1')

mergedtest6d7d9dretailer_v3$base_index <- mergedtest6d7d9dretailer_v3$`BASELINE UNIT / VOLUME`/mergedtest6d7d9dretailer_v3$`UNIT / VOLUME`
mergedtraining6d7d9dretailer_v3$base_index <- mergedtraining6d7d9dretailer_v3$`BASELINE UNIT / VOLUME`/mergedtraining6d7d9dretailer_v3$`UNIT / VOLUME`

names(mergedtest6d7d9dretailer_v3)[71]<-"baseline_sales_volume"
names(mergedtest6d7d9dretailer_v3)[68]<-"actual_sales_volume"

names(mergedtraining6d7d9dretailer_v3)[71]<-"baseline_sales_volume"
names(mergedtraining6d7d9dretailer_v3)[68]<-"actual_sales_volume"

mergedtest6d7d9dretailer_v3$volume_squared <-  (mergedtest6d7d9dretailer_v3$actual_sales_volume)^2
mergedtraining6d7d9dretailer_v3$volume_squared <- (mergedtraining6d7d9dretailer_v3$actual_sales_volume)^2

mergedtest6d7d9dretailer_v3$volume_trip <-  (mergedtest6d7d9dretailer_v3$actual_sales_volume)^3
mergedtraining6d7d9dretailer_v3$volume_trip <- (mergedtraining6d7d9dretailer_v3$actual_sales_volume)^3

mergedtest6d7d9dretailer_v3$log_price <-  log(mergedtest6d7d9dretailer_v3$PRICE)
mergedtraining6d7d9dretailer_v3$log_price <- log(mergedtraining6d7d9dretailer_v3$PRICE)
# 
preObj <- preProcess(mergedtraining6d7d9dretailer_v3[, -c(1:67,75)], method=c("scale"))
newData <- predict(preObj, mergedtraining6d7d9dretailer_v3[, -c(1:67,75)])
mergedtraining6d7d9dretailer_v6 <- cbind(newData, mergedtraining6d7d9dretailer_v3[,  c(1:67,75)])
# 
 preObj <- preProcess(mergedtest6d7d9dretailer_v4[, -c(1:67,75)], method=c("scale"))
 newData <- predict(preObj, mergedtest6d7d9dretailer_v4[, -c(1:67,75)])
 mergedtest6d7d9dretailer_v6 <- cbind(newData, mergedtest6d7d9dretailer_v4[, c(1:67,75)])

 
 mergedtest6d7d9dretailer_v6$ppi <- mergedtest6d7d9dretailer_v6$PRICE/mergedtest6d7d9dretailer_v6$`BASELINE PRICE`
 mergedtraining6d7d9dretailer_v6$ppi <- mergedtraining6d7d9dretailer_v6$PRICE/mergedtraining6d7d9dretailer_v6$`BASELINE PRICE`
 
  mergedtest6d7d9dretailer_v6$base_index <- mergedtest6d7d9dretailer_v6$baseline_sales_volume/mergedtest6d7d9dretailer_v6$actual_sales_volume
 mergedtraining6d7d9dretailer_v6$base_index <- mergedtraining6d7d9dretailer_v6$baseline_sales_volume/mergedtraining6d7d9dretailer_v6$actual_sales_volume
 
 mergedtest6d7d9dretailer_v5$volume1_squared <-  (mergedtest6d7d9dretailer_v5$corrected_sales_in_volume)^2
 mergedtraining6d7d9dretailer_v4$volume1_squared <- (mergedtraining6d7d9dretailer_v4$corrected_sales_in_volume)^2
 
 mergedtest6d7d9dretailer_v5$volume1_trip <-  (mergedtest6d7d9dretailer_v5$corrected_sales_in_volume)^3
 mergedtraining6d7d9dretailer_v4$volume1_trip <- (mergedtraining6d7d9dretailer_v4$corrected_sales_in_volume)^3